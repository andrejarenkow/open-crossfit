...
try:
    ...
    fig_categorias = px.bar(df_barras, x="Prova", y="Contagem", color="Categoria", title='Número de atletas por categoria por prova',
                           color_discrete_map={'RX':'#03DAC5', 'Scale':'#BB86FC', 'Foundations':'#FF4181'})
    # Definindo o tipo de eixo x como 'category'
    fig_categorias.update_xaxes(type='category')
    c2.plotly_chart(fig_categorias)
    
    dados_tabela_box = dados_box[['competitorName','profilePicS3key', 'affiliateName', 'age', 'scoreDisplay_1','scale_descrito_2', 'scoreDisplay_2','scale_descrito_3', 'scoreDisplay_3']]
    dados_tabela_box
